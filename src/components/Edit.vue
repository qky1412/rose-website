        ...
        <el-row>
          ...
          <el-col :span="8">
            ...
            <single-image ref="image_report"
                          :default-img-list="report_image_list"
...
export default {
  ...
  data () {
    return {
      ...
      form: {
        ...
        no: '',
        number: '',
        smears: [{location: '', weasand_lens: -1, type: -1, diagnosis: '', images: []}],
        cell_diagnosis: '',
  ...
  methods: {
    ...
    addSmear () {
      this.form.smears.push({location: '', weasand_lens: -1, type: -1, diagnosis: '', images: []})
    },
    formSmearRefs (index) {
